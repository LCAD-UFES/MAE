...
void  distorted_to_undistorted_image_coord (double Xd, double Yd, double *Xu, double *Yu);
void  undistorted_to_distorted_image_coord (double Xu, double Yu, double *Xd, double *Yd);
