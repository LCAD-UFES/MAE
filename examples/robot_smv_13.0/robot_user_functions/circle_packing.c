...
static BOUNDARIES *global_boundaries_list = NULL;
static CIRCLE_LIST *global_circle_list = NULL;
static int global_initial_num_cylinders = 0;
static int global_num_new_cylinders = 0;
static int global_tries = 0;

static CYLINDER_LIST *global_cylinder_list;
...
{	
	mae_logging_trace("circle_packing::circle_packing_execute");
...
{
	mae_logging_trace("circle_packing::init_circle_packing");
