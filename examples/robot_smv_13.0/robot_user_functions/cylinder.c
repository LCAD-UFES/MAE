...
void
compute_3D_cylinder (CYLINDER *cylinder, double *cylinder_3D_points, int arcs, int circles, int size, double angle)
{
	...
	{
		x = (double) circle * size / (double) circles - (size / 2.0);
