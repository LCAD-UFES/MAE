...
/* Prototypes */
#ifndef	IMPORTING 
extern DLLEXPORT int StereoInitialize (void); 
...
extern DLLEXPORT int StereoTriangulation (double *XL, double *XR, double *xL, double *xR);
...
extern DLLEXPORT int CameraProjection (double *p_dblImagePoint, double *p_dblWorldPoint, int nCameraSide);
#else 
