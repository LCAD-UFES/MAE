...
DLLEXPORT int *MaeDistorted2UndistortedImage (int nCameraSide, int *p_nDistortedImage, int w, int h)
{
	static int p_nUndistortedImage[640*480];
	static char p_cImageBuffer[3*640*480];
	int i, j, nPixel;
