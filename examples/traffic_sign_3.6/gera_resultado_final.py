...
arq_output = open("resultadoFinal20120909.csv", 'w')


# Lendo os arquivos
r = open("/home/car02/MAE/examples/traffic_sign_3.6/traffic_sign_3.6_RED/hit_statistics_minchinton20120909.csv")
g = open("/home/car02/MAE/examples/traffic_sign_3.6/traffic_sign_3.6_GREEN/hit_statistics_minchinton20120909.csv")
b = open("/home/car02/MAE/examples/traffic_sign_3.6/traffic_sign_3.6_BLUE/hit_statistics_minchinton20120909.csv")
