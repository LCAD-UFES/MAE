...
#define RANDOM_FACES_TEST "/media/shared_win_dir/_mae/seq01_train_good"
#define RANDOM_FACES_TRAIN "/media/shared_win_dir/_mae/seq01_test_good" //

#define IMAGE_WIDTH		1628
#define IMAGE_HEIGHT	1236
