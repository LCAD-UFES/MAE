...
changePointData (POINT_LIST *L, KEY elementToChange, KEY newValue)
{
	...
	{
		if (elementToChange.nonDominantEyePoint.x == INT_MIN)
		{	
			newValue.nonDominantEyePoint.x = INT_MIN;
			newValue.nonDominantEyePoint.y = INT_MIN;
			newValue.world_point.x = INT_MIN;
			newValue.world_point.y = INT_MIN;
			newValue.world_point.z = INT_MIN;
		}
		else if (elementToChange.dominantEyePoint.x == INT_MIN)
		{
			newValue.dominantEyePoint.x = current->element.dominantEyePoint.x;
			newValue.dominantEyePoint.y = current->element.dominantEyePoint.y;
			newValue.world_point.x = INT_MIN;
			newValue.world_point.y = INT_MIN;
			newValue.world_point.z = INT_MIN;
		}
