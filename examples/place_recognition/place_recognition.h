...
#define NUMBER_OF_TRAINING_FRAMES (3783)
#define NUMBER_OF_TEST_FRAMES (2784)
#define DATA_SET_FILE_TRAIN ("basepos-UFES-TRAIN-LAPS-20171122-5m-1m.txt")
#define DATA_SET_FILE_TEST ("livepos-UFES-TRAIN-LAPS-20171122-5m-1m.txt")
