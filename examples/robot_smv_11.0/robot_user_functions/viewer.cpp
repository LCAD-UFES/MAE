	...
	switch (key)
	{
		...
		case 'i':
                ...
                case 'v':
			{
				...
				coordinates = fopen ("coordinates.dat", "w");
				...
				model_3d_save(&model_3d, coordinates);
                ...
                case 'V':
			{
				...
				coordinates = fopen ("coordinates.dat", "r");
		...
		case 'h':
			ViewerEraseMap ();
			model_3d_rotate_face(&model_3d, get_current_camera_pair(), MODEL_3D_X_AXIS, g_factor * M_PI/18.0);
		...
		case 'j':
			ViewerEraseMap ();
			model_3d_rotate_face(&model_3d, get_current_camera_pair(), MODEL_3D_Y_AXIS, g_factor * M_PI/18.0);
			model_3d_view(&model_3d);
                        break;
		case 'J':
			ViewerEraseMap ();
		...
		case 'k':
			ViewerEraseMap ();
			model_3d_rotate_face(&model_3d, get_current_camera_pair(), MODEL_3D_Z_AXIS, g_factor * M_PI/18.0);
			model_3d_view(&model_3d);
                        break;
		case 'K':
			ViewerEraseMap ();
		...
		case 'b':
			ViewerEraseMap ();
			model_3d_translate_face(&model_3d, get_current_camera_pair(), MODEL_3D_X_AXIS, g_factor * M_PI/18.0);
			model_3d_view(&model_3d);
                        break;
		case 'B':
			ViewerEraseMap ();
		...
		case 'n':
			ViewerEraseMap ();
			model_3d_translate_face(&model_3d, get_current_camera_pair(), MODEL_3D_Y_AXIS, g_factor * M_PI/18.0);
			model_3d_view(&model_3d);
                        break;
		case 'N':
			ViewerEraseMap ();
		...
		case 'm':
			ViewerEraseMap ();
			model_3d_translate_face(&model_3d, get_current_camera_pair(), MODEL_3D_Z_AXIS, g_factor * M_PI/18.0);
			model_3d_view(&model_3d);
                        break;
		case 'M':
			ViewerEraseMap ();
		...
		case 'z':
			ViewerEraseMap ();
			model_3d_center_face(&model_3d, get_current_camera_pair());
			model_3d_view(&model_3d);
                        break;
		case 'Z':
			ViewerEraseMap ();
			model_3d_straight_face(&model_3d, get_current_camera_pair());
			model_3d_view(&model_3d);
                        break;
		// Quits viewer
		case 'Q':
