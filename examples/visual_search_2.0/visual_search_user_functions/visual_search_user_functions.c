...
/*
********************************************************
* Function: output_handler_target		       *
* Description:  				       *
* Inputs:					       *
* Output:					       *
********************************************************
...
void 
output_handler_target (OUTPUT_DESC *output, int type_call, int mouse_button, int mouse_state)
{
	static int index = 0;
	int i;
	int wo, ho;
	...
	for (i = 0; i < wo * ho; i++)
		output->neuron_layer->neuron_vector[i].output.fval = 0.0;
	
	output->neuron_layer->neuron_vector[index].output.fval = 1.0;
