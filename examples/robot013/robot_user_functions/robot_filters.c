...
//				filter_desc->output->neuron_vector[i].output.fval = sqrtf(dif_accumulator);
				filter_desc->output->neuron_vector[i].output.fval = CONST_MINUS - sqrtf(dif_accumulator);
			}
		}
		break;
...
//				filter_desc->output->neuron_vector[i].output.ival = (int)sqrtf(dif_accumulator);
				filter_desc->output->neuron_vector[i].output.ival = (int)CONST_MINUS - sqrtf(dif_accumulator);
			}
		}
		break;
	}
