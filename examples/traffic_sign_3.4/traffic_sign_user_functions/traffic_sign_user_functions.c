...
GetConfidence(PARAM_LIST *pParamList)
{
	...
	output.ival = (int) (sign_count_cadidates[0].confidence * 100.0 * 100.0);
	//printf("confidence = %d\n", output.ival);
	
	if (best_sign.confidence < sign_count_cadidates[0].confidence)
		best_sign = sign_count_cadidates[0];
