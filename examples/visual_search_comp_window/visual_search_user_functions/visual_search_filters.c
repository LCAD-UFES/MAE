...
void v1_activation_map_filter (FILTER_DESC *filter_desc)
{
	...
	NEURON_LAYER *nlOutput = NULL, *nlInput = NULL;
	...
	if (!flag)
	{
		...
		connect_neuron_layers_gaussianly_with_uniform_connection_pattern (nlInput, nlOutput, nInputsPerNeuron, fltGaussianRadius);
