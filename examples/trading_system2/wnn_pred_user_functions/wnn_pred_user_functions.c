...
void
base_output_handler_average_stop_gain_stop_loss (OUTPUT_DESC *output, int type_call, int mouse_button, int mouse_state, double (*EvaluateOutput) (OUTPUT_DESC *, int *))
{
...
{
	base_output_handler_average_stop_gain_stop_loss (output, type_call, mouse_button, mouse_state, EvaluateOutputAverageStopGainStopLoss);
}
