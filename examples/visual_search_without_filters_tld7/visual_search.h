...
#define TRAINING_INPUT_PATH ("/dados/TLD/TLD/03_pedestrian1/")
#define REACALL_INPUT_PATH ("/dados/TLD/TLD/03_pedestrian1/")
#define INPUT_PATH ("/dados/TLD/TLD/03_pedestrian1/")
