...
make clean
make
./visual_search visual_search_01_david_various_scales.cml
...
make clean
make
./visual_search visual_search_02_jumping_various_scales.cml
...
make clean
make
./visual_search visual_search_03_pedestrian1_various_scales.cml
...
make clean
make
./visual_search visual_search_04_pedestrian2_various_scales.cml
...
make clean
make
./visual_search visual_search_05_pedestrian3_various_scales.cml
...
make clean
make
./visual_search visual_search_06_car_various_scales.cml
...
make clean
make
./visual_search visual_search_07_motocross_various_scales.cml
...
make clean
make
./visual_search visual_search_08_volkswagen_various_scales.cml
...
make clean
make
./visual_search visual_search_09_carchase_various_scales.cml
...
make clean
make
./visual_search visual_search_10_panda_various_scales.cml
