...
% Alberto: Descomente as tres linhas abaixo na primeira vez que rodar
% Avelino: Descomentar as três linhas abaixo quebra o makebatches
fprintf(1,'Converting Raw files into Matlab format \n');
converter; 
mnistresize(100, 100); % Number of samples per digit for trainning and test. Put at least the size of batches (100).
