...
f = fopen('/dados/MNIST/t10k-images-idx3-ubyte','r');
[a,count] = fread(f,4,'int32');
  
g = fopen('/dados/MNIST/t10k-labels-idx1-ubyte','r');
...
f = fopen('/dados/MNIST/train-images-idx3-ubyte','r');
[a,count] = fread(f,4,'int32');

g = fopen('/dados/MNIST/train-labels-idx1-ubyte','r');
[l,count] = fread(g,2,'int32');
