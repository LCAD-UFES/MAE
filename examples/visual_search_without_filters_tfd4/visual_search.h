...
#define TRAINING_INPUT_PATH ("/dados/TrainIJCNN2013/")
#define REACALL_INPUT_PATH ("/dados/TestIJCNN2013Download/")

// Macros
#define NL_WIDTH (16 * 4 + 1)
#define NL_HEIGHT (12 * 4 + 1)
...
extern "C" NEURON_OUTPUT CheckTrafficSignDetectionMandatory (PARAM_LIST *);
...
extern NEURON_OUTPUT CheckTrafficSignDetectionMandatory (PARAM_LIST *);
