...
functions_to_minimize (const gsl_vector *independent_variables, void *void_target_data, gsl_vector *fi)
{
	...
	CameraProjection (num_3D_points, target_data->virtual_cylinder_2D_left, target_data->virtual_cylinder_3D, LEFT_CAMERA);
...
//	static CYLINDER cylinder = {283.04427212, -137.15358221, 1056.09556013, 365.29919230-55.0, 79.94068419, -0.1, 0.1};
	...
	static int is_parameter_to_optimize[NUMBER_OF_CYLINDER_PARAMETERS] = {1, 1, 1, 1,    1,        1,     1};
...
double
fit_cylinder (CYLINDER *cylinder, CYLINDER *guessed_cylinder, NEURON_LAYER *disparity_map, int *working_area)
{
