...
#define POSE_MIN		1
#define POSE_MAX		26
#define MIN_PERSON_ID 		0  // Deveria ser 1. Ajustado para zero por causa de GetFace2()
#define MAX_PERSON_ID 		99 // Usado apenas em GetFace2()
#define MIN_ILLUMINATION	0  // Usado apenas em GetFace2()
#define MAX_ILLUMINATION	13 // Usado apenas em GetFace2()
...
#define IMAGE_WIDTH		384  // largura da imagem da mae. Quando alterar o face recog tem que alterar aqui tamb�m
#define IMAGE_HEIGHT	288  // altura da imagem da mae. Quando alterar o face recog tem que alterar aqui tamb�m
