...
void cylinder_list_move_first (CYLINDER_LIST *list);

void cylinder_list_move_last (CYLINDER_LIST *list);

void cylinder_list_move_previous (CYLINDER_LIST *list);

void cylinder_list_move_next (CYLINDER_LIST *list);

void cylinder_list_move (CYLINDER_LIST *list, int steps);
 
int is_cylinder_list_out (CYLINDER_LIST *list);
...
CYLINDER * cylinder_list_get_current (CYLINDER_LIST *list);

CYLINDER * cylinder_list_get_last (CYLINDER_LIST *list);

CYLINDER *cylinder_list_get_highest (CYLINDER_LIST *list);

CYLINDER *cylinder_list_get_lowest(CYLINDER_LIST *list);

CYLINDER * cylinder_list_get_nearest (CYLINDER_LIST *list);
...
int cylinder_list_add (CYLINDER_LIST *list, CYLINDER cylinder);
...
void cylinder_list_delete_current (CYLINDER_LIST *list);
...
int cylinder_list_index_nearest (CYLINDER_LIST *list);
