...
#ifndef __ROBOT_NEURON_NETWORK_HPP
#define __ROBOT_NEURON_NETWORK_HPP
...
class mae::smv::RobotNeuronNetwork
{
	...
	*/
	...
	/**
	Copies a region of the right image input layer to a mathing region input layer.
	...
	*/
	private: bool loadCache(const string basename, int half, int side, const string format);
