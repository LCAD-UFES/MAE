...
#define VERGENCE_RANGE_FACTOR 5
	...
	if (g_DispData == NULL)
	{
		...
		nAllSamples = (image_right.neuron_layer->dimentions.x / VERGENCE_RANGE_FACTOR);
	...
	nMaxScan = image_right.wxd + (image_right.neuron_layer->dimentions.x / VERGENCE_RANGE_FACTOR);
